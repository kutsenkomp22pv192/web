...
function Search() {
    ...
    useEffect(()=>{
        ...
        dispatch(getServerBySearch({searchString:searchString}))
    }, [searchString])
    ...
    return         <section>
        <div className="discover-search-container ">
            <div className={' flex flex-row xl:w-7/12 w-full '}>
                ...
                <button className="flex flex-row justify-center items-center flex-nowrap bg-[#5865f2] w-10 h-10 xl:w-12 xl:h-12 rounded-md ml-4 text-white ">
